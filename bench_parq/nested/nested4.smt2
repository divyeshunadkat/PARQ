...
(rule (=> (and (inv1 a i j N) (< j N) (= a0 (store a i (+ 1 (select a i)))) (= j0 (+ j 1))) (inv1 a0 i j0 N)))

(rule (=> (and (inv1 a i j N) (not (< j N)) (= a0 (store a i (- N (select a i)))) (= i0 (+ i 1)) ) (inv0 a i0 N)))
